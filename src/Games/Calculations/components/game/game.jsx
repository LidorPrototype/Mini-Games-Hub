...
import { GameUtil } from './gameUtils';
import styles from './game.module.css';

const gameUtil = new GameUtil();


export const Game = ({operatorList, setStartGame}) => {
  ...
  useEffect(() => {
    ...
    const currentOperator = gameUtil.getRandomItem(operatorList);
  ...
  const clsIncludedCenter = (cls) => [styles.centerDiv, cls].join(' ');
